...
// SharedMemoryHandle 描述了一块通过共享内存传递的大数据集的访问方式
type SharedMemoryHandle struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	FilePath      string                 `protobuf:"bytes,1,opt,name=file_path,json=filePath,proto3" json:"file_path,omitempty"`                                                           // 共享内存对应的文件路径
	Offset        int64                  `protobuf:"varint,2,opt,name=offset,proto3" json:"offset,omitempty"`                                                                              // 数据开始的偏移量
	Length        int64                  `protobuf:"varint,3,opt,name=length,proto3" json:"length,omitempty"`                                                                              // 数据长度（字节）
	Format        string                 `protobuf:"bytes,4,opt,name=format,proto3" json:"format,omitempty"`                                                                               // 数据格式，如 "arrow.ipc"
	Rows          int64                  `protobuf:"varint,5,opt,name=rows,proto3" json:"rows,omitempty"`                                                                                  // 行数统计，便于上层校验
	Metadata      map[string]string      `protobuf:"bytes,6,rep,name=metadata,proto3" json:"metadata,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // 额外元数据，例如 schema 摘要
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SharedMemoryHandle) Reset() {
	*x = SharedMemoryHandle{}
	mi := &file_datasource_v1_datasource_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SharedMemoryHandle) Descriptor() ([]byte, []int) {
	return file_datasource_v1_datasource_proto_rawDescGZIP(), []int{20}
}
...
var file_datasource_v1_datasource_proto_msgTypes = make([]protoimpl.MessageInfo, 24)
